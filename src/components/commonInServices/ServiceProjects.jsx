...
import { projects } from '../../../public/Data/teamMembers';
                        ...
                        <div  key={project.title} className={`flex bg-color-white w-full flex-col-reverse gap-8 sm:gap-0 items-center sm:items-start sm:flex-row justify-between p-3 sm:p-5  trans rounded-md  border-[1px]`}>
                            <div className='flex  flex-col h-full justify-around'>
                                ...
                                <div className='flex w-full items-center justify-start gap-10'>
                                    <a href={project.demoLink} className='flex items-center gap-1 rounded-md px-3 py-1 trans hover:bg-hover-main-color bg-main-color text-white cursor-pointer '>
                                        {t("projectLiveDemo")}
                                        <FiLink className={`${i18n.language == "en" ? "mt-0" : "mt-1"} text-white text-sm`} />
                                    </a>
                                    <a href={project.repoLink} className='flex gap-1 items-center rounded-md px-3 py-1 trans  hover:bg-gray-100 border-2 cursor-pointer '>
                                        {t("projectRepo")}
                                        <BiCodeAlt  className={`${i18n.language == "en" ? "mt-0" : "mt-1"} text-sm  `} />
                                    </a>
                                </div>
                            </div>
